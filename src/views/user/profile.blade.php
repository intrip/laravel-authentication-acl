...
<div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <a href="{{URL::action('Jacopo\Authentication\Controllers\UserController@editUser',['id' => $user_profile->user_id])}}" class="btn btn-lg btn-primary"><i class="fa fa-pencil-square-o"></i> Edit user</a>
        </div>
    </div>
    <hr/>
