...
Route::get('/admin/login', [
        "Jacopo\\Authentication\\Controllers\\AuthController@getAdminLogin",
        "as" => "user.admin.login"
]);
Route::get('/login', [
        "Jacopo\\Authentication\\Controllers\\AuthController@getClientLogin",
        "as" => "user.login"
]);
Route::get('/user/logout', [
        "Jacopo\\Authentication\\Controllers\\AuthController@getLogout",
        "as" => "user.logout"
]);
...
Route::get('/user/change-password', [
        'Jacopo\Authentication\Controllers\AuthController@getChangePassword',
        "as" => "user.change-password"
]);
Route::get('/user/recovery-password', [
        "Jacopo\\Authentication\\Controllers\\AuthController@getReminder",
