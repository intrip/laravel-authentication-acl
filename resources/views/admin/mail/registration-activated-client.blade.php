		...
		<td class="container" bgcolor="#FFFFFF">
			...
			<table>
				<tr>
					<td>
						<h3>Hi {!! $body['email'] !!},</h3>
						<p class="lead">Welcome to: {!! Config::get('acl_base.app_name') !!}</p>
						<!-- Callout Panel -->
						<p class="callout" style="background-color: #ccc; padding: 10px;">
							<strong>Your email has been confirmed successfully.</strong> You can now login to the website using <a href="{!! URL::to('/admin') !!}" style="color:#15c;">this link</a>.
						</p><!-- /Callout Panel -->					
